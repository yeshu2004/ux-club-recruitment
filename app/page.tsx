    ...
    <div className="h-full w-full relative">
      ...
      <div className="h-[100dvh] w-full relative overflow-hidden">
        ...
        <div className="absolute bottom-5 z-10 text-[#FF9A0A] left-5">
          ...
          <h1 className="uppercase text-[5rem] text-[#FC4503] leading-[0.9] font-[HelveticaNow]">
            The
          </h1>
      ...
      <div className="bg-[#FFE3BB] h-[100dvh] w-full">
        <div className="text-center pt-28 px-5">
          ...
          <Link href="/form">
            <button className="absolute bottom-5 left-5 right-5  md:w-auto border-2 border-[#FC4503] text-[#FC4503] rounded-full px-6 py-3 uppercase font-[HelveticaNow] text-sm sm:text-base">
              take me to the form
            </button>
          </Link>
        </div>
